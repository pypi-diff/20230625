# Comparing `tmp/xia_git_gitlab-0.1.8-cp39-none-win_amd64.whl.zip` & `tmp/xia_git_gitlab-0.1.9-cp39-none-macosx_11_0_x86_64.whl.zip`
...
+Zip file size: 164622 bytes, number of entries: 7
+-rw-r--r--  2.0 unx       95 b- defN 23-Jun-25 17:03 xia_git_gitlab/__init__.py
+-rw-r--r--  2.0 unx   455712 b- defN 23-Jun-25 17:04 xia_git_gitlab/git.cpython-39-darwin.so
+-rw-r--r--  2.0 unx      151 b- defN 23-Jun-25 17:04 xia_git_gitlab-0.1.9.dist-info/LICENSE.txt
+-rw-r--r--  2.0 unx      700 b- defN 23-Jun-25 17:04 xia_git_gitlab-0.1.9.dist-info/METADATA
+-rw-r--r--  2.0 unx      108 b- defN 23-Jun-25 17:04 xia_git_gitlab-0.1.9.dist-info/WHEEL
+-rw-r--r--  2.0 unx       15 b- defN 23-Jun-25 17:04 xia_git_gitlab-0.1.9.dist-info/top_level.txt
+?rw-rw-r--  2.0 unx      603 b- defN 23-Jun-25 17:04 xia_git_gitlab-0.1.9.dist-info/RECORD
+7 files, 457384 bytes uncompressed, 163542 bytes compressed:  64.2%
```
